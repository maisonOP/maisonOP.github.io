...
export const DATA = {
  ...
  summary: L(
    "I'm open to any research topic — Neural Interfaces (BCI, neural decoding), Evaluation & Datasets, LLM, VLA, Agent, and more. **I'm always happy to discuss interesting AI research collaborations!**",
    "Neural Interfaces(BCI, neural decoding), Evaluation & Datasets, LLM, VLA, Agent 등 어떤 연구 주제든 열려있습니다. **흥미로운 AI 연구 협업이라면 언제든 환영합니다!**"
  ),
  ...
  contact: {
    ...
    social: {
      ...
      GoogleScholar: {
        name: "Google Scholar",
        url: "https://scholar.google.com/citations?user=bN51Qw8AAAAJ",
  ...
  news: [
    {
      ...
      text: L(
        "Our paper [SPIA](https://github.com/maisonOP/spia) has been accepted to **ACL 2026 (Main Conference)**. 🎉",
        "저희 논문 [SPIA](https://github.com/maisonOP/spia)가 **ACL 2026** (Main Conference)에 게재 승인되었습니다. 🎉"
      ),
    },
    {
      date: L("Nov 2025", "2025.11"),
